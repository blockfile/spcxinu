...
// ERC-20, which is what an SPCX-paired launch is. See contracts/V4Buyer.sol for
...
async function main() {
  ...
  console.log(`  3. the bot approves ${config.rewardSymbol || 'SPCX'} to it automatically on the next buyback`);
  console.log('');
